...
namespace Usuarios.Py {
    ...
    public partial class bancoDataSet : global::System.Data.DataSet {
        ...
        public partial class usuarioDataTable : global::System.Data.TypedTableBase<usuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuarioRow AddusuarioRow(string nome_usuario, string placa, string endereco, string telefone, string login, string senha) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuarioRow FindByid_usuario(long id_usuario) {
        ...
        public partial class usuarioRow : global::System.Data.DataRow {
            ...
            public long id_usuario {
                get {
                    return ((long)(this[this.tableusuario.id_usuarioColumn]));
                }
                set {
            ...
            public string placa {
                get {
                    return ((string)(this[this.tableusuario.placaColumn]));
                }
                set {
                    this[this.tableusuario.placaColumn] = value;
                }
            }
...
namespace Usuarios.Py.bancoDataSetTableAdapters {
    ...
    public partial class usuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `usuario` WHERE ((`id_usuario` = @p1) AND (`nome_usuario` = @p2) AND " +
                "(`placa` = @p3) AND (`endereco` = @p4) AND (`telefone` = @p5) AND (`login` = @p6" +
                ") AND (`senha` = @p7))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `usuario` (`nome_usuario`, `placa`, `endereco`, `telefone`, `login`, " +
                "`senha`) VALUES (@p1, @p2, @p3, @p4, @p5, @p6)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `usuario` SET `nome_usuario` = @p1, `placa` = @p2, `endereco` = @p3, `telefone` = @p4, `login` = @p5, `senha` = @p6 WHERE ((`id_usuario` = @p7) AND (`nome_usuario` = @p8) AND (`placa` = @p9) AND (`endereco` = @p10) AND (`telefone` = @p11) AND (`login` = @p12) AND (`senha` = @p13))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Usuarios.Py.Properties.Settings.Default.bancoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id_usuario, nome_usuario, placa, endereco, telefone, login, senha\r\n" +
                "FROM            usuario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT endereco, id_usuario, login, nome_usuario, placa, senha, telefone FROM usu" +
                "ario";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        id_usuario, nome_usuario, placa, endereco, telefone, login, senha\r\n" +
                "FROM            usuario\r\n";
        ...
        public virtual int FilBy(bancoDataSet.usuarioDataTable dataTable, string text) {
        ...
        public virtual bancoDataSet.usuarioDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bancoDataSet.usuarioDataTable dataTable = new bancoDataSet.usuarioDataTable();
        ...
        public virtual int FillBy(bancoDataSet.usuarioDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByBusca(bancoDataSet.usuarioDataTable dataTable) {
        ...
        public virtual bancoDataSet.usuarioDataTable GetDataByBusca() {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            bancoDataSet.usuarioDataTable dataTable = new bancoDataSet.usuarioDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bancoDataSet.usuarioDataTable dataTable) {
        ...
        public virtual int Delete(long p1, string p2, string p3, string p4, string p5, string p6, string p7) {
        ...
        public virtual int Update(string p1, string p2, string p3, string p4, string p5, string p6, long p7, string p8, string p9, string p10, string p11, string p12, string p13) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
